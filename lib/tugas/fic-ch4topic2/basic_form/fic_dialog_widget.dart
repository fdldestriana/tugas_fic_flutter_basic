...
// import 'package:project_flutter_pertama/meet_2/ch4topic2/basic_widget/scaffold_widget.dart';
...
class _FICDialogWidgetState extends State<FICDialogWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("FIC - Dialog & Bottmoshee"),
      ),
      body: Container(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content: SingleChildScrollView(
                          child: ListBody(
                            children: const [Text('Your order was placed!')],
                          ),
                        ),
                        actions: [
                          ElevatedButton(
